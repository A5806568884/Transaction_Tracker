...
<body>
    ...
    <div>
        ...
        <label for="give_cash_to_customer">GIVE CASH TO CUSTOMER</label>
        <input type="number" name="give_cash_to_customer" id="give_cash_to_customer">
    ...
    <div>
        ...
        <label for="total_cash_paid">TOTAL CASH PAID</label><input type="number" name="total_cash_paid" id="total_cash_paid" readonly><br />
        <label for="balance">RETURN/GET/BALANCED</label><input type="number" name="balance" id="balance" readonly><br />
        <label for="withdraw_amount">WITHDRAW AMOUNT</label><input type="number" name="withdraw_amount" id="withdraw_amount" readonly><br />
